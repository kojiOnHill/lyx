...
{
	// Some math operators
	addAccents("\\forall", getutf8(0xf0100));
	addAccents("\\complement", getutf8(0xf0101));
	addAccents("\\partial", getutf8(0xf0102));
	...
	addAccents("\\setminus", getutf8(0xf0116));
	addAccents("\\circ", getutf8(0xf0118));
	addAccents("\\centerdot", getutf8(0xf0119));
	addAccents("\\propto", getutf8(0xf011d));
	addAccents("\\infty", getutf8(0xf011e));
	addAccents("\\angle", getutf8(0xf0120));
	addAccents("\\measuredangle", getutf8(0xf0121));
	addAccents("\\sphericalangle", getutf8(0xf0122));
	addAccents("\\mid", getutf8(0xf0123));
	addAccents("\\nmid", getutf8(0xf0124));
	addAccents("\\parallel", getutf8(0xf0125));
	addAccents("\\nparallel", getutf8(0xf0126));
	addAccents("\\wedge", getutf8(0xf0127));
	addAccents("\\vee", getutf8(0xf0128));
	addAccents("\\cap", getutf8(0xf0129));
	addAccents("\\cup", getutf8(0xf012a));
	addAccents("\\int", getutf8(0xf012b));
	...
	addAccents("\\approx", getutf8(0xf0148));
	addAccents("\\approxeq", getutf8(0xf014a));
	addAccents("\\asymp", getutf8(0xf014d));
	addAccents("\\Doteq", getutf8(0xf0151));
	addAccents("\\fallingdotseq", getutf8(0xf0152));
	addAccents("\\risingdotseq", getutf8(0xf0153));
	...
	addAccents("\\le", getutf8(0xf0164));
	addAccents("\\ge", getutf8(0xf0165));
	addAccents("\\leqq", getutf8(0xf0166));
	addAccents("\\geqq", getutf8(0xf0167));
	addAccents("\\lneqq", getutf8(0xf0168));
	addAccents("\\gneqq", getutf8(0xf0169));
	addAccents("\\ll", getutf8(0xf016a));
	addAccents("\\gg", getutf8(0xf016b));
	addAccents("\\between", getutf8(0xf016c));
	addAccents("\\nless", getutf8(0xf016e));
	addAccents("\\ngtr", getutf8(0xf016f));
	addAccents("\\nleq", getutf8(0xf0170));
	addAccents("\\ngeq", getutf8(0xf0171));
	addAccents("\\lesssim", getutf8(0xf0172));
	addAccents("\\gtrsim", getutf8(0xf0173));
	addAccents("\\lessgtr", getutf8(0xf0176));
	addAccents("\\gtrless", getutf8(0xf0177));
	addAccents("\\prec", getutf8(0xf017a));
	addAccents("\\succ", getutf8(0xf017b));
	addAccents("\\preccurlyeq", getutf8(0xf017c));
	addAccents("\\succcurlyeq", getutf8(0xf017d));
	addAccents("\\precsim", getutf8(0xf017e));
	addAccents("\\succsim", getutf8(0xf017f));
	...
	addAccents("\\nsupseteq", getutf8(0xf0189));
	addAccents("\\subsetneq", getutf8(0xf018a));
	addAccents("\\supsetneq", getutf8(0xf018b));
	addAccents("\\uplus", getutf8(0xf018e));
	addAccents("\\sqsubset", getutf8(0xf018f));
	addAccents("\\sqsupset", getutf8(0xf0190));
	addAccents("\\sqsubseteq", getutf8(0xf0191));
	addAccents("\\sqsupseteq", getutf8(0xf0192));
	addAccents("\\sqcap", getutf8(0xf0193));
	addAccents("\\sqcup", getutf8(0xf0194));
	addAccents("\\oplus", getutf8(0xf0195));
	addAccents("\\ominus", getutf8(0xf0196));
	addAccents("\\otimes", getutf8(0xf0197));
	addAccents("\\oslash", getutf8(0xf0198));
	addAccents("\\odot", getutf8(0xf0199));
	addAccents("\\circledcirc", getutf8(0xf019a));
	addAccents("\\circledast", getutf8(0xf019b));
	addAccents("\\circleddash", getutf8(0xf019d));
	addAccents("\\boxplus", getutf8(0xf019e));
	addAccents("\\boxminus", getutf8(0xf019f));
	addAccents("\\boxtimes", getutf8(0xf01a0));
	addAccents("\\boxdot", getutf8(0xf01a1));
	addAccents("\\vdash", getutf8(0xf01a2));
	addAccents("\\dashv", getutf8(0xf01a3));
	addAccents("\\top", getutf8(0xf01a4));
	...
	addAccents("\\vartriangleleft", getutf8(0xf01b2));
	addAccents("\\vartriangleright", getutf8(0xf01b3));
	addAccents("\\trianglelefteq", getutf8(0xf01b4));
	addAccents("\\trianglerighteq", getutf8(0xf01b5));
	addAccents("\\multimap", getutf8(0xf01b8));
	addAccents("\\intercal", getutf8(0xf01ba));
	addAccents("\\veebar", getutf8(0xf01bb));
	addAccents("\\barwedge", getutf8(0xf01bc));
	addAccents("\\star", getutf8(0xf01c6));
	addAccents("\\divideontimes", getutf8(0xf01c7));
	addAccents("\\bowtie", getutf8(0xf01c8));
	addAccents("\\ltimes", getutf8(0xf01c9));
	addAccents("\\rtimes", getutf8(0xf01ca));
	addAccents("\\leftthreetimes", getutf8(0xf01cb));
	addAccents("\\rightthreetimes", getutf8(0xf01cc));
	addAccents("\\curlyvee", getutf8(0xf01ce));
	addAccents("\\curlywedge", getutf8(0xf01cf));
	addAccents("\\Subset", getutf8(0xf01d0));
	addAccents("\\Supset", getutf8(0xf01d1));
	addAccents("\\Cap", getutf8(0xf01d2));
	addAccents("\\Cup", getutf8(0xf01d3));
	addAccents("\\pitchfork", getutf8(0xf01d4));
	addAccents("\\lessdot", getutf8(0xf01d6));
	addAccents("\\gtrdot", getutf8(0xf01d7));
	addAccents("\\llless", getutf8(0xf01d8));
	addAccents("\\gggtr", getutf8(0xf01d9));
	addAccents("\\lesseqgtr", getutf8(0xf01da));
	addAccents("\\gtreqless", getutf8(0xf01db));
	addAccents("\\curlyeqprec", getutf8(0xf01de));
	addAccents("\\curlyeqsucc", getutf8(0xf01df));
	addAccents("\\ntrianglelefteq", getutf8(0xf01ec));
	addAccents("\\ntrianglerighteq", getutf8(0xf01ed));
	addAccents("\\vdots", getutf8(0xf01ee));
	...
	if (cur.inTexted()) {
		...
		for (int s = cur.depth() - 1; s >= 0; --s) {
			...
			if (cs.asInsetMath() && cs.asInsetMath()->asHullInset()) {
				TeXMathStream ws(os);
				cs.asInsetMath()->asHullInset()->header_writeMath(ws);
				break;
			}
		}
		...
		for (int s = cur.depth() - 1; s >= 0; --s) {
			...
			if (inset && inset->asHullInset()) {
				TeXMathStream ws(os);
				inset->asHullInset()->footer_writeMath(ws);
				break;
			}
		}
