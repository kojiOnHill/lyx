...
void PrefColors::setCurrentTheme(int const color_row)
{
	if (newcolors_[color_row] != theme_colors_[color_row])
		...
		// colors in the current color_row matched
		// check for other color_row's
		// we don't care about matches with other themes since it would be
		// useless and rarely happen. its implementation cost (esp. cpu time)
		// obviously exceeds the benefit.
