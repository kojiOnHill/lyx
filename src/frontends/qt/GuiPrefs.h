...
private:
	...
	/// set in theme_name and indicates it in themesLW. If the color set doesn't
	/// match existing themes, it sets an empty string to themes_name and
	/// deselect items in themesLW.
